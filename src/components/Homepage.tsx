            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 animate-bounce-in" style={{ animationDelay: '0.6s' }}>
              ...
              <Link to="/submit">
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="group border-2 border-gold text-gold hover:bg-gold hover:text-white-foreshadow transition-all duration-300 hover:shadow-soft animate-pulse-glow"
                >
